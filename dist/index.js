...
var USBPrinter = {
    ...
    printTSPL: function (base64TSPLCommands) {
        if (Platform.OS === "ios") {
            ...
            RNUSBPrinter.printRawData(base64TSPLCommands, function (error) { return console.warn(error); });
        }
    },
    /**
     ...
     */
    generateTSPLTextLabel: function (width, height, gap, text, x, y, fontSize) {
        return new Promise(function (resolve, reject) {
            if (Platform.OS === "ios") {
            ...
            RNUSBPrinter.generateTSPLTextLabel(width, height, gap, text, x, y, fontSize, function (base64) { return resolve(base64); }, function (error) { return reject(error); });
        });
    },
    /**
    ...
    encodeTSPLCommand: function (tsplCommand) {
        return new Promise(function (resolve, reject) {
            ...
            RNUSBPrinter.encodeTSPLCommand(tsplCommand, function (base64) { return resolve(base64); }, function (error) { return reject(error); });
        });
    },
    /**
    ...
    printTSPLTextLabel: function (width, height, gap, text, x, y, fontSize) {
        if (Platform.OS === "ios") {
            ...
            RNUSBPrinter.printTSPLTextLabel(width, height, gap, text, x, y, fontSize, function (error) { return console.warn(error); });
        }
    },
    /**
     ...
     * @returns Promise<string> Base64-encoded TSPL commands
     */
    generateTSPLImageLabel: function (base64Image, labelWidth, labelHeight, gap, x, y) {
        return new Promise(function (resolve, reject) {
            if (Platform.OS === "ios") {
                reject(new Error("TSPL printing not supported on iOS"));
                return;
            ...
            RNUSBPrinter.generateTSPLImageLabel(base64Image, labelWidth, labelHeight, gap, x, y, function (base64) { return resolve(base64); }, function (error) { return reject(error); });
        });
    },
    /**
     ...
     * @returns Promise<string> Base64-encoded TSPL commands
     */
    generateTSPLImageLabelFromURL: function (imageUrl, labelWidth, labelHeight, gap, x, y) {
        return new Promise(function (resolve, reject) {
            if (Platform.OS === "ios") {
                reject(new Error("TSPL printing not supported on iOS"));
                return;
            ...
            RNUSBPrinter.generateTSPLImageLabelFromURL(imageUrl, labelWidth, labelHeight, gap, x, y, function (base64) { return resolve(base64); }, function (error) { return reject(error); });
        });
    },
    /**
     ...
     * @param fontSize Font size (1-8)
     */
    printTSPLImageLabel: function (base64Image, labelWidth, labelHeight, gap, imageX, imageY, text, textX, textY, fontSize) {
        if (Platform.OS === "ios") {
            console.warn("TSPL printing not supported on iOS");
        }
        else {
            ...
            RNUSBPrinter.printTSPLImageLabel(base64Image || "", labelWidth, labelHeight, gap, imageX, imageY, text || "", textX, textY, fontSize, function (error) { return console.warn(error); });
        }
    },
    /**
     * `columnWidth`
